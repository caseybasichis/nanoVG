...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("nanovg_ocaml", ["src"], [])];
     lib_c = [("nanovg_ocaml", "src", [])];
     flags =
       [
          (["oasis_library_nanovg_ocaml_ccopt"; "compile"],
            [(OASISExpr.EBool true, S [A "-ccopt"; A "-I${pkg_ctypes}/.."])]);
          (["oasis_library_nanovg_ocaml_cclib"; "link"],
            [
          ...
          (["oasis_library_nanovg_ocaml_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true,
...
let my_dispatch = function
  | After_rules ->
    rule "generated ml"
      ~dep:"src/ffi_stubgen.byte"
      ~prod:"src/ffi_generated.ml"
      (fun _ _ ->
         Cmd(S[P"src/ffi_stubgen.byte"; A"-ml"; Sh">"; A"src/ffi_generated.ml"]));
    ...
    flag ["link"; "program"; "native"; "link_with_nanovg"; "ocaml"]
      (S[A"-cclib"; A"-lnanovg"; A"-cclib"; A"-Llib";]);
...
let () =
  dispatch (MyOCamlbuildBase.dispatch_combine [ dispatch_default; my_dispatch ])
