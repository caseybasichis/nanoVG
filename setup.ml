...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8928ae58ea24fa51c52d56c79ffa4fdd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Paolo Donadeo <p.donadeo@4sigma.it>"];
          authors = ["Paolo Donadeo <p.donadeo@4sigma.it>"];
          homepage = None;
          synopsis = "OCaml bindings to NanoVG";
          description =
            Some
              [
                 OASISText.Para
                 ...
                 OASISText.Para
                   "This library provides an OCaml binding to NanoVG"
              ];
          categories = [];
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("./build_nanovg.sh", [])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Nvg"; "Ffi_bindings"; "Ffi_generated"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "nanovg-ocaml";
               ...
               Flag
                 ({
                     cs_name = "build_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "Build example";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "example_gles2";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "build_example", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples";
                   ...
                   {exec_custom = false; exec_main_is = "example_gles2.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Z\244\b\163\241B\199`\138\165N\252\162\212i\193";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
